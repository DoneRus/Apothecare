      ...
      <main className="container mx-auto px-4 py-12">
        <div className="max-w-md mx-auto text-center py-16 bg-white rounded-lg shadow-md">
          ...
          <p className="text-gray-600 mb-8">
            Sorry, we couldn't find the order you're looking for. It may have been removed or doesn't exist.
          </p>
          <Link href="/orders" className="inline-block bg-primary text-white px-6 py-3 rounded-md hover:bg-primary-dark transition">
            Return to Orders
          </Link>
        </div>
      </main>
